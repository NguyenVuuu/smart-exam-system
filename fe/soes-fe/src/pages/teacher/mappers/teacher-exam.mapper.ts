...
export const toExamSchedule = (dto: TeacherExamScheduleDto): ExamSchedule => {
  ...
  return {
    ...
    allowStudentReview: dto.reviewPolicy !== 'NONE',
    enableTabLock: dto.enableTabLock,
    maxTabSwitches: dto.maxTabSwitches ?? undefined,
    requireFullscreen: dto.requireFullscreen,
    enableWebcam: dto.enableWebcam, enableScreenMonitoring: dto.enableScreenMonitoring,
...
export const toTeacherSchedulePayload = (schedule: ExamSchedule): TeacherExamSchedulePayload => ({
  ...
  enableTabLock: schedule.enableTabLock ?? true,
  maxTabSwitches: schedule.maxTabSwitches ?? 3,
  requireFullscreen: schedule.requireFullscreen ?? false,
  enableWebcam: schedule.enableWebcam ?? false,
  enableScreenMonitoring: schedule.enableScreenMonitoring ?? false,
  ...
  distributionMode: schedule.distributionMode ?? 'FIXED_ORDER',
