...
export const MOCK_COURSE_MATERIALS: CourseMaterial[] = [
  {
    ...
    subjectName: 'Lập trình Java căn bản',
    courseCode: 'JAVA_01_HK1_2026',
    title: 'Chương 1 - Tổng quan Java',
    fileName: 'Chuong_1_Tong_Quan_Java.pdf',
    fileType: 'PDF',
    fileSize: '2.4 MB',
    checksum: 'sha256-java-chuong-1',
  ...
  },
  {
    ...
    subjectName: 'Lập trình Java căn bản',
    courseCode: 'JAVA_01_HK1_2026',
    title: 'Chương 2 - Hướng đối tượng',
    fileName: 'Chuong_2_Huong_Doi_Tuong_OOP.pdf',
    fileType: 'PDF',
    fileSize: '4.1 MB',
    checksum: 'sha256-java-chuong-2-oop',
    storageProvider: 'SUPABASE',
  ...
  },
  {
    ...
    courseCode: 'JAVA_02_HK1_2026',
    title: 'Chương 1 - Tổng quan Java',
    fileName: 'Tong_quan_Java_lop_02.pdf',
    fileType: 'PDF',
    fileSize: '2.4 MB',
    checksum: 'sha256-java-chuong-1',
    storageProvider: 'SUPABASE',
    uploadedAt: '2026-08-03 08:20',
    selectedForAI: true,
    downloadUrl: '#',
  },
  {
    ...
    courseCode: 'DSA_02_HK1_2026',
    title: 'Cây nhị phân',
    fileName: 'Cay_Nhi_Phan.pdf',
    fileType: 'PDF',
    fileSize: '3.2 MB',
    checksum: 'sha256-dsa-binary-tree',
    storageProvider: 'SUPABASE',
    uploadedAt: '2026-08-12 15:45',
    selectedForAI: false,
    downloadUrl: '#',
  },
]
