...
export default function TeacherScheduleStats({ summary }: TeacherScheduleStatsProps) {
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 mb-4">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white p-3.5 shadow-sm">
        ...
        <div>
          ...
          <p className="text-lg font-bold text-emerald-600">{summary.open}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white p-3.5 shadow-sm">
        ...
        <div>
          ...
          <p className="text-lg font-bold text-sky-600">{summary.scheduled}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white p-3.5 shadow-sm">
        ...
        <div>
          ...
          <p className="text-lg font-bold text-slate-700">{summary.closed}</p>
        </div>
      </div>
    </div>
  )
