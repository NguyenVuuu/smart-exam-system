      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-xl animate-in fade-in zoom-in-95 duration-150">
        <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs font-bold text-gray-900">Lịch Sử Sinh Câu Hỏi Bằng AI</h3>
              <p className="text-xs text-gray-500">Lưu lại thông tin giáo viên, tệp tài liệu, prompt và số lượng câu đã tạo</p>
            </div>
          </div>
          ...
          {MOCK_AI_HISTORY.map((item) => (
            <div key={item.id} className="p-4 bg-gray-50 border border-gray-100 rounded-xl space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-gray-400">{item.generatedAt}</span>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200/60 flex items-center gap-1.5 text-xs text-gray-500">
