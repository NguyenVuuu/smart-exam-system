...
export const ADMIN_SHARED_QUESTIONS: SharedQuestionAdmin[] = [
  ...
  { id: 'sq-3', content: 'Trong Java, kiểu int có kích thước 32 bit.', subjectCode: 'CS101', type: 'TRUE_FALSE', difficulty: 'EASY', contributorName: 'Lê Hoàng', reviewedBy: 'Nguyễn Văn An', status: 'APPROVED' },
]

export const ADMIN_EXAMS: AdminExam[] = [
  { id: 'exam-mid-java', title: 'Bài thi Giữa kỳ Lập trình Java', subjectName: 'Lập trình Java', authorName: 'Nguyễn Văn An', category: 'MIDTERM', structure: 'MIXED', totalPoints: 10, questionCount: 4, durationMinutes: 60, status: 'APPROVED' },
  { id: 'exam-final-java', title: 'Bài thi Cuối kỳ Lập trình Java', subjectName: 'Lập trình Java', authorName: 'Nguyễn Văn An', category: 'FINAL', structure: 'MIXED', totalPoints: 10, questionCount: 4, durationMinutes: 90, status: 'PENDING_APPROVAL' },
  { id: 'exam-quiz-ds', title: 'Bài kiểm tra Quiz Cấu trúc dữ liệu', subjectName: 'Cấu trúc dữ liệu và giải thuật', authorName: 'Lê Hoàng', category: 'QUIZ', structure: 'OBJECTIVE', totalPoints: 10, questionCount: 3, durationMinutes: 15, status: 'DRAFT' },
  { id: 'exam-final-db', title: 'Bài thi Cuối kỳ Cơ sở dữ liệu', subjectName: 'Cơ sở dữ liệu', authorName: 'Trần Thị Lan', category: 'FINAL', structure: 'OBJECTIVE', totalPoints: 10, questionCount: 40, durationMinutes: 75, status: 'APPROVED' },
]

export const ADMIN_EXAM_SCHEDULES: AdminExamSchedule[] = [
  { id: 'sch-java-08', examTitle: 'Bài thi Giữa kỳ Lập trình Java', courseCodes: ['JAVA_01_HK1_2026'], date: '15/12/2025', time: '08:00 - 09:00', location: 'Online', ipPolicy: 'Không giới hạn', proctors: ['Lê Hoàng'], status: 'OPEN' },
  { id: 'sch-java-13', examTitle: 'Bài thi Giữa kỳ Lập trình Java', courseCodes: ['JAVA_02_HK1_2026'], date: '15/12/2025', time: '13:00 - 14:00', location: 'Online', ipPolicy: 'Không giới hạn', proctors: ['Trần Thị Lan'], status: 'SCHEDULED' },
  { id: 'sch-final-db', examTitle: 'Bài thi Cuối kỳ Cơ sở dữ liệu', courseCodes: ['DB_01_HK1_2026'], date: '18/12/2025', time: '08:00 - 09:15', location: 'Phòng máy A201', ipPolicy: 'IP trường', proctors: ['Nguyễn Văn An'], status: 'SCHEDULED' },
]
