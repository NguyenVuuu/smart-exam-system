...
export function buildGenerationPrompt(
  ...
  return [
    ...
    "- difficultyReason: Giải thích ngắn gọn, tự nhiên và chuẩn xác trong 1-2 câu lý do xếp độ khó dựa trên kiến thức và kỹ năng tư duy. TUYỆT ĐỐI KHÔNG ghi tiền tố 'Mức Dễ:', 'Mức Trung bình:', 'Mức Khó:', 'Lý do:' vào nội dung trường này mà chỉ viết trực tiếp câu giải thích (Ví dụ: 'Câu hỏi kiểm tra kiến thức nhận biết cơ bản về cú pháp và từ khóa kế thừa trong lập trình hướng đối tượng Java.').",
