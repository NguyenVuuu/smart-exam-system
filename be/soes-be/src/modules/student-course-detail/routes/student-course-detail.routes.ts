...
router.get('/:courseOfferingId/posts', authenticate, requireStudent(), controller.getTimeline)
router.get('/:courseOfferingId/exams/:examId', authenticate, requireStudent(), controller.getExamDetail)
